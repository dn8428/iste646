    ...
    <div class="main-content">
        <div class="main-section">
            ...
            <div class="image-container">
                <img src="<?php echo $_SESSION['rootPath'] ?>assets/img/javier-trueba-iQPr1XkF5F0-unsplash.jpg"
                     alt="classroom">
            ...
            <div class="special-events-container">
                ...
                <div class="events-container">
                    <div class="events-1">
                        <img src="<?php echo $_SESSION['rootPath'] ?>assets/img/george-zheng-UA_TpTR5oAI-unsplash.jpg"
                             alt="event picture 1" href="#"
                             target="_blank">
                        <figcaption>Photo by <a
                    ...
                    <div class="events-1">
                        <img src="<?php echo $_SESSION['rootPath'] ?>assets/img/sugar-golf-XOSwAvWexBo-unsplash.jpg"
                             alt="event picture 2" href="#"
                             target="_blank">
                        <figcaption>Photo by <a
                    ...
                    <div class="events-1">
                        <img src="<?php echo $_SESSION['rootPath'] ?>assets/img/giorgio-trovato-_XTY6lD8jgM-unsplash.jpg"
                             alt="event picture 3"
                             href="#" target="_blank">
                        <figcaption>Photo by <a
